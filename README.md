...
SQL is the language used to interact with and manage Relational Databses

- [ ] Why do tables need a `primary key`?

A primary key is a key that uniquely identifies each entry in a database.
...
A third table with a foreign key from each of the tables you want to track.
